...
**YOU ARE IN: `autoclaw/polecats/dementus/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/autoclaw/` (rig root) or other directories
...
**Your mail address:** `autoclaw/polecats/dementus`
**Your rig:** autoclaw
**Your Witness:** `autoclaw/witness`
...
| Ask Witness for help | `gt mail send autoclaw/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`autoclaw/witness`) when:
...
```bash
gt mail send autoclaw/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
